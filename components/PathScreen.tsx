...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  description: { fontSize: '16px', maxWidth: '600px', margin: '0 auto', opacity: 0.9 },
  mainContent: { maxWidth: '800px', margin: '-40px auto 0', backgroundColor: COLORS.card, borderRadius: '12px', padding: '32px', boxShadow: '0 8px 30px rgba(0,0,0,0.12)', position: 'relative', zIndex: 4 },
