...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  initialInputsContainer: { display: 'flex', gap: '12px', flexDirection: 'column', width: '90%', margin: '0 auto' },
  ...
  mainInputWrapper: { display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'center', width: '90%', margin: '0 auto' },
