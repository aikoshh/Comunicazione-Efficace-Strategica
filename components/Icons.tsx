...
export const VerbalIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z" />
    <path d="M19 10v2a7 7 0 0 1-14 0v-2" />
    <line x1="12" y1="19" x2="12" y2="23" />
...
export const AdminIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12.22 18.22a2.5 2.5 0 0 0-4.44 0" />
        <path d="M16.5 13.5a2.5 2.5 0 0 0 0-5" />
        <path d="M7.5 13.5a2.5 2.5 0 0 1 0-5" />
        <path d="M12 5.8a2.5 2.5 0 0 0-5 0" />
        <circle cx="12" cy="12" r="10" />
        <path d="M12 12a2.5 2.5 0 0 0 0 5" />
        <path d="M12 12a2.5 2.5 0 0 1 0-5" />
        <path d="M16.5 18.5a2.5 2.5 0 0 0 0-5" />
        <path d="M7.5 18.5a2.5 2.5 0 0 1 0-5" />
        <path d="M12 5.8a2.5 2.5 0 0 1 5 0" />
    </svg>
);
...
export const ListeningIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M16 11.23a7 7 0 1 1-8.46 0" />
        <path d="M12 21a2 2 0 0 0 2-2v-3a4 4 0 0 0-4-4H8" />
        <path d="M18 9a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2" />
    </svg>
);

export const ConflictIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M14.5 16.5 18 20l-1.5 1.5-3.5-3.5" />
    <path d="m5 16 4-4" />
    <path d="M16 5l-4 4" />
    <path d="m9.5 11.5 1.5 1.5" />
    <path d="m8 8 3.5 3.5" />
    <path d="M14 14l-4-4" />
    <path d="m20 6-4.5 4.5" />
  </svg>
);
...
export const HealthcareIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M20.2 7.8a4.5 4.5 0 0 0-6.4 0L12 9.6l-1.8-1.8a4.5 4.5 0 0 0-6.4 6.4l1.8 1.8L12 20.4l6.2-6.2 1.8-1.8a4.5 4.5 0 0 0 0-6.4z"/>
  </svg>
);
...
export const CustomerCareIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M17 18a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2"/>
    <path d="M12 14v4"/>
    <path d="M12 22a7.1 7.1 0 0 0 7-7c0-4-3-6-3-6-1 0-2 1-3 1s-2-1-3-1c0 0-3 2-3 6a7.1 7.1 0 0 0 7 7Z"/>
    <path d="M5 2c-1 4-1 6 0 8"/>
    <path d="M19 2c1 4 1 6 0 8"/>
  </svg>
);

export const RetailIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="m21.44 11.05-9-9a2 2 0 0 0-2.83 0l-9 9a2 2 0 0 0 0 2.83l9 9a2 2 0 0 0 2.83 0l9-9a2 2 0 0 0 0-2.83z"/>
    <line x1="12" y1="22" x2="12" y2="12"/>
    <line x1="2" y1="12" x2="22" y2="12"/>
  </svg>
);

export const BankingIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const LeadershipIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M6 14V8a2 2 0 0 1 2-2h2"/>
    <path d="M6 18H4a2 2 0 0 1-2-2v-4a2 2 0 0 1 2-2h2"/>
    <path d="M14 18h2a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-2"/>
  </svg>
);