...
export const VOICE_RUBRIC_CRITERIA_EN = [
    { id: "pacing_breath", label: "Pacing & Breath" },
    ...
    { id: "strategy_alignment", label: "Alignment with CES Goal" },
];
...
export const STRATEGIC_CHECKUP_EXERCISES_EN: Exercise[] = [
    {
      ...
      scenario: 'You need to give feedback to a colleague, Alex, who submitted incomplete work with several errors. It\'s the first time this has happened, but the project is critical.',
      task: 'Write or record the feedback you would give Alex to address the situation constructively.',
    ...
    },
    {
      ...
      task: 'Write or record your immediate response to handle the situation professionally without escalating.',
      difficulty: DifficultyLevel.INTERMEDIO,
      exerciseType: ExerciseType.WRITTEN,
    },
    {
      ...
      task: 'Write or record the first question you would ask to fully understand the client\'s problem, demonstrating active listening.',
...
export const MODULES_EN: Module[] = [
  // Fundamentals
  {
    ...
    description: 'Hone your ability to listen not just to hear, but to truly understand by identifying keywords that reveal true intentions.',
    icon: ListeningIcon,
    ...
    exercises: [
      {
        ...
        scenario: 'A colleague tells you: "I\'m a bit worried about tomorrow\'s presentation, I\'m not sure the data section is clear enough and I fear the client might ask tough questions."',
      ...
      },
      {
        ...
        task: 'Identify the keywords and phrases that reveal the client\'s true decision criteria, beyond the price. What are their priorities and internal pressures?',
  ...
  },
  {
    ...
    exercises: [
      {
        id: 'e1',
        title: 'Feedback to a Poor-Performing Collaborator',
        scenario: 'You need to give feedback to Mark, a member of your team, who has recently missed several deadlines and whose work quality has been below standard. You want to address the issue constructively without demotivating him.',
      ...
      },
      {
        ...
        task: 'Respectfully explain the situation to Luke, detailing the impact of his behavior on your work and suggesting a different approach.',
        difficulty: DifficultyLevel.INTERMEDIO,
      },
      {
        id: 'e7',
        title: 'Feedback to a Senior Stakeholder',
        scenario: 'You need to deliver critical feedback to a director from another department regarding a delay on their part that is blocking a strategic project. The conversation is delicate due to hierarchy and potential political implications.',
    ...
    exercises: [
       {
        ...
        scenario: 'You are in an initial meeting with a potential client who is struggling to clearly express what they need. Their requests are vague and contradictory.',
        task: 'Use a series of open-ended and probing questions to help the client better define their goals and needs.',
        difficulty: DifficultyLevel.BASE,
      },
      {
        id: 'e9',
        title: 'Exploring a Drop in Motivation',
        scenario: 'You\'ve noticed that a usually proactive team member has become quiet and disengaged. You want to understand what\'s going on without being intrusive.',
        task: 'Initiate a 1-on-1 conversation. Use open-ended questions and active listening to explore the possible causes of their change in attitude and offer support.',
        difficulty: DifficultyLevel.INTERMEDIO,
      },
      {
        id: 'e6',
    ...
    exercises: [
      {
        ...
        task: 'Approach the colleague gently and privately and ask if they can lower their voice, without making them feel attacked or embarrassed.',
        difficulty: DifficultyLevel.BASE,
      },
      {
        id: 'e3',
        title: 'Disagreeing with a Colleague on a Project',
        scenario: 'You and your colleague, Julia, have completely different views on how to proceed with an important project. Tension is rising, and you need to find a solution to avoid blocking the team\'s work.',
        task: 'Start a conversation with Julia to discuss your differences. Try to understand her point of view and find a compromise or a shared solution.',
        difficulty: DifficultyLevel.INTERMEDIO,
      },
      {
        id: 'e13',
        title: 'Disagreeing with Your Partner',
        scenario: 'Your partner is annoyed because you\'ve been spending a lot of time at work recently. They say, "You\'re never here!" You want to address their frustration without starting an argument.',
      ...
      },
      {
        ...
        scenario: 'During a family gathering, a relative makes a passive-aggressive comment about one of your life choices (work, relationships, etc.). The comment hurts you and creates awkwardness.',
      ...
      },
      {
        ...
        scenario: 'As a team leader, you must inform your team that due to budget cuts, the project they were very passionate about has been canceled. There is a risk of strong discontent.',
  ...
  },
  {
    ...
    description: 'Train your pace, tone, and pauses to make your message more impactful and persuasive.',
    icon: VoiceIcon,
    ...
    exercises: [
      {
        ...
        scenario: 'You need to present an important proposal to a client who is known to be very demanding and often interrupts. The goal is to maintain a calm and authoritative tone, without being overwhelmed by the pressure.',
      ...
      },
      {
        ...
        scenario: 'During an important meeting, a colleague repeatedly interrupts you while you are presenting your data. You need to regain the floor and maintain control of the conversation without appearing aggressive, using a firm but collaborative tone of voice.',
      ...
      },
      {
        ...
        scenario: 'You are a team leader and need to present a new company strategy that will involve significant changes and possible uncertainties. Your goal is to inspire confidence and motivate the team, despite the difficulties.',
  ...
  // Sectoral Packs
  {
    ...
    exercises: [
        {
            id: 's1e1',
            title: 'Communicating a Difficult Diagnosis',
            scenario: 'You are a doctor and must inform a patient and their family of a chronic illness diagnosis. The atmosphere is tense and filled with anxiety.',
            task: 'Deliver the diagnosis clearly, empathetically, and supportively, answering questions and managing the family\'s emotional reactions.',
            difficulty: DifficultyLevel.AVANZATO,
        }
    ],
  },
  {
    ...
    exercises: [
        {
            id: 's2e1',
            title: 'Meeting with a Concerned Parent',
            scenario: 'You are a teacher and need to meet with the parents of a student who is having behavioral difficulties in class. The parents are on the defensive.',
            task: 'Lead the conversation collaboratively, presenting the facts objectively and working with the parents to create a support plan for the student.',
            difficulty: DifficultyLevel.INTERMEDIO,
        }
    ],
  },
    ...
    exercises: [
        {
            ...
            scenario: 'A customer calls you, extremely angry because their product did not arrive in time for an important event. They threaten to leave negative reviews everywhere.',
    ...
    exercises: [
        {
            ...
            scenario: 'A potential client is convinced of the value of your solution, but says: "This is great, but it costs twice as much as your main competitor."',
    ...
    exercises: [
        {
            ...
            scenario: 'Your team\'s key project has failed, missing a major company goal. Morale is low, and there is fear of the consequences.',
            task: 'Hold a team meeting. Deliver a message that acknowledges the failure without placing blame, inspires resilience, and refocuses the team on learnings and next steps.',
            difficulty: DifficultyLevel.AVANZATO,
        }
    ],
  },
...
export const QUESTION_LIBRARY_EN: StrategicQuestionCategory[] = [
  {
    category: 'Open-ended Exploratory Questions',
    description: 'Use them to open up the conversation, gather broad information, and encourage the other person to talk.',
    questions: [
      ...
      { question: 'Can you tell me more about how you came to that conclusion?', description: 'Encourages sharing the thought process, useful for understanding deep motivations.' },
      { question: 'What does the ideal solution look like to you?', description: 'Shifts the focus from the problem to the solution, stimulating a constructive vision.' },
  ...
  },
  {
    ...
    description: 'Ideal for going deeper on a specific point, clarifying ambiguity, and obtaining crucial details.',
    questions: [
      ...
      { question: 'What have you already tried to do to solve this?', description: 'Avoids suggesting already-attempted solutions and shows respect for their efforts.' },
      { question: 'Of all these points, which one worries you the most right now?', description: 'Helps to prioritize and address the most pressing issue.' },
    ],
  },
  {
    category: 'Hypothetical and Future-oriented Questions',
    description: 'Perfect for breaking deadlocks, exploring possibilities, and shifting the focus towards the future.',
    questions: [
      ...
      { question: 'Let\'s imagine we are six months from now and we have solved this problem. What do you see?', description: 'Encourages a positive vision and helps define the final goal.' },
      ...
      { question: 'What is the worst-case scenario if we do nothing?', description: 'Highlights the cost of inaction and creates a sense of urgency.' },
    ],
  },
  {
    ...
    questions: [
      { question: 'What did you learn from this experience?', description: 'Promotes learning and personal growth.' },
...
export const PREPARATION_CHECKLIST_EN: ChecklistItem[] = [
    ...
    { id: 'c2', text: 'What is the likely state of mind of my counterpart? How can I tune in?' },
    ...
    { id: 'c7', text: 'Have I prepared at least one open-ended question to demonstrate listening?' },
    ...
    { id: 'c10', text: 'Have I checked my emotional state? Am I calm, centered, and ready?' },
];
